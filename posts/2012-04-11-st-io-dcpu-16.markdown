...
functional core and work your way up from there -- this is also the approach
I've taken here.
...
safe this way (converting `IO` to `ST`, however, is tricky bussiness, but this
is not needed for our emulator).
